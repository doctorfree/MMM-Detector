...
rpm_dependencies=(atlas-devel file-devel file-libs sox sox-devel wget autoconf automake binutils bison flex gcc gcc-c++ glibc-devel libtool make pkgconf strace byacc ccache cscope ctags elfutils indent ltrace perf valgrind)
# Check dependencies
if [ "${debian}" ]
then
